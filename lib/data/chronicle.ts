...
export const chronicle: ChronicleSection[] = [
  {
    ...
    title: "What Is Ravenspire",
    plain: "A fun-first social realm where wit earns standing.",
    body: [
      "Ravenspire is a social platform dressed in castle stone. You post, you jest, you make bold Calls about what happens next, and the realm remembers who was sharp and who was merely loud. It is a game of reputation, played with words.",
      ...
      "We built Ravenspire fun-first, on purpose. It is a place to compete, banter, and build a name. It is not a casino, not a market for speculation, and not a scheme. If a feature ever stops being fun, it has failed, and we treat it that way.",
    ],
  },
  {
    slug: "the-ravenry",
  ...
  },
  {
    ...
    body: [
      "Every citizen of Ravenspire swears to one of six Houses. House Corvane keeps its ravens and its cunning. House Emberfall burns bold. House Frosthold endures anything. House Stormcrest strikes fast. House Nightvale trades in secrets. House Goldmane hunts glory with a lion's patience. Your House is your banner, your rivalry, and your team.",
  ...
  },
  {
    ...
    body: [
      "Crests are the medals of Ravenspire, marks struck for real deeds: a legendary Call, a season survived, a rivalry won, a moment the realm will not forget. They live on your profile like a coat of arms that tells your story at a glance.",
  ...
  },
  {
    ...
    body: [
      "Everything you do in Ravenspire earns points: posting, making Calls, fighting for your House, keeping the realm alive. Points accumulate across a Season as a straightforward measure of contribution. No luck, no lottery, just a ledger of what you actually did.",
      ...
      "The claim is non-custodial from end to end. Ravenspire never holds your rewards on your behalf, never takes possession in the middle, and never stands between you and what you earned. We publish the tree, you make the claim, and the record is open for anyone to check.",
  ...
  },
  {
    ...
    body: [
      "Every citizen gets a wallet, and here is the part that matters: it is yours in the fullest sense. The keys are generated for you alone, we never see them, and we never store them. Ravenspire cannot move your funds, freeze your wallet, or recover your keys, because we simply do not have them.",
      "Your wallet is exportable at any time. Take your keys to any standard wallet application and carry on without us. There is no lock-in, no exit fee, and no permission to ask. If Ravenspire vanished tomorrow, everything in your wallet would still be exactly where you left it, under your control.",
